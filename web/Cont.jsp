...
//                    int session_id=(Integer)sess.getAttribute("id");
//                    String session_name=(String)sess.getAttribute("email");
...
<!--		<div class="form1">
			<div class="contennt">
				...
				<div class="input-group">
                                    ...
                                    placeholder="e.g-Deep" name="fname"> <input type="text"
                                    aria-label="Last name" class="form-control"
                                    placeholder="e.g-Mahur" name="lname">
